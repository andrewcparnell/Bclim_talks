...
author: Andrew C Parnell (also Judy Allen, Niamh Cahill, Thinh Doan, John Haslett,
  Ben Horton, Brian Huntley, Andrew Kemp, James Sweeney)
...
\begin{center}
\includegraphics[width=10cm]{flow_chart.png}
\end{center}
...
\begin{center}
\includegraphics[width=10cm]{Monticchio_pollen.png}
\end{center}
...
\begin{center}
\includegraphics[width=10cm]{Monticchio_AETPET.png}
\end{center}
...
\begin{center}
\includegraphics[width=4cm]{RSL_input.png}
\end{center}
...
\begin{center}
\includegraphics[width=10cm]{RSL_output.png}
\end{center}
